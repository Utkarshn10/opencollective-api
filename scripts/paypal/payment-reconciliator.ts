...
const findRefundedContributions = async (hostSlugs: string[], fix = false) => {
  for (const hostSlug of hostSlugs) {
    ...
    try {
      ...
      const apiUrl = 'reporting/transactions?fields=all&page_size=100&page=1&transaction_status=V';
